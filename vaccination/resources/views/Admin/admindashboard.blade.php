  ...
  <div class="admin-shell">
    ...
    <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
      ...
      <div class="sidebar-user">
        <img class="avatar-img avatar-md sidebar-user-avatar" src="{{asset('Admin/assets/images/avatar/avatar.jpg')}}" alt="Admin Hasan">
          ...
          <div class="navbar-actions ms-auto">
            ...
            <div class="dropdown">
              <button class="profile-button dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="avatar-img avatar-sm" src="{{asset('Admin/assets/images/avatar/avatar.jpg')}}" alt="Admin Hasan">
